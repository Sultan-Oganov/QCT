...
const PaddingHorizontalIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={17} fill="none" {...props}>
    <g clipPath="url(#a)" fillRule="evenodd" clipRule="evenodd" fill="#2C2D2E">
      <path d="M10.667 3.833A.667.667 0 0 1 10 4.5H6a.667.667 0 0 1 0-1.333h4c.368 0 .667.298.667.666ZM10.667 13.167a.667.667 0 0 1-.667.666H6A.667.667 0 1 1 6 12.5h4c.368 0 .667.299.667.667Z" />
      <path
        opacity={0.3}
