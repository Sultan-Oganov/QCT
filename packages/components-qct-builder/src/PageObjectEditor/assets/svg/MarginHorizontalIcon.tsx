...
const MarginHorizontalIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width={16} height={17} fill="none" {...props}>
    <g clipPath="url(#a)" fillRule="evenodd" clipRule="evenodd" fill="#2C2D2E">
      <path d="M4 15.833c0-.368.298-.666.667-.666h6.666a.667.667 0 1 1 0 1.333H4.667A.667.667 0 0 1 4 15.833ZM4 1.167C4 .799 4.298.5 4.667.5h6.666a.667.667 0 1 1 0 1.333H4.667A.667.667 0 0 1 4 1.167Z" />
      <path
        opacity={0.3}
...
export default MarginHorizontalIcon;
